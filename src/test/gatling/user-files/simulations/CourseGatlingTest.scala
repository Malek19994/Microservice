...
class CourseGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Course entity")
        ...
        .repeat(2) {
            ...
            .get("/services/armory/api/courses")
            .headers(headers_http_authenticated)
            .check(status.is(200)))
            .pause(10 seconds, 20 seconds)
            .exec(http("Create new course")
            .post("/services/armory/api/courses")
            .headers(headers_http_authenticated)
            .body(StringBody("""{
                "id":null
                , "courseTitle":"SAMPLE_TEXT"
                , "courseDescription":"SAMPLE_TEXT"
                , "coursePrice":null
                , "courseLevel":"NOVICE"
                }""")).asJson
            .check(status.is(201))
            ...
            .repeat(5) {
                ...
                .get("/services/armory${new_course_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created course")
            .delete("/services/armory${new_course_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
